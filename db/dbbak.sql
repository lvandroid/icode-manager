...
(
	...
	class_num varchar(16) null comment '班级',
	...
	create_time timestamp default CURRENT_TIMESTAMP null comment '录入时间',
	update_time timestamp default CURRENT_TIMESTAMP null on update CURRENT_TIMESTAMP comment '更新时间',
	enable tinyint(1) default 0 null comment '是否激活'
)
charset=utf8;

create table student_genearch
(
...
(
	student_id varchar(11) null comment '学员ID',
...
(
	...
	enable tinyint(1) default 1 null comment '1',
	constraint id
		unique (id)
)
charset=utf8;
...
(
	...
	role_id bigint(11) not null,
	root_role tinyint(1) default 0 null
)
charset=utf8;

create definer = icode@`%` procedure add_all_router(IN roleId bigint)
begin
...
create definer = icode@`%` function getChildrenRouter(routerId bigint) returns varchar(10000)
begin
